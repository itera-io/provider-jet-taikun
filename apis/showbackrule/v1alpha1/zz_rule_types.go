...
type RuleObservation struct {
	...
	// The creator of the showback rule.
...
type RuleParameters struct {
	...
	// Reference to a Credential in showbackcredential to populate showbackCredentialId.
	// +kubebuilder:validation:Optional
	ShowbackCredentialIDRef *v1.Reference `json:"showbackCredentialIdRef,omitempty" tf:"-"`

	// Selector for a Credential in showbackcredential to populate showbackCredentialId.
	// +kubebuilder:validation:Optional
