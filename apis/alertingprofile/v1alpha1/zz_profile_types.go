...
type ProfileObservation struct {
	...
	// The creator of the alerting profile.
	...
	// The name of the organization which owns the profile.
	OrganizationName *string `json:"organizationName,omitempty" tf:"organization_name,omitempty"`

	// The name of the Slack configuration to notify.
...
type ProfileParameters struct {
	...
	// Reference to a Configuration in slackconfiguration to populate slackConfigurationId.
	// +kubebuilder:validation:Optional
	SlackConfigurationIDRef *v1.Reference `json:"slackConfigurationIdRef,omitempty" tf:"-"`

	// Selector for a Configuration in slackconfiguration to populate slackConfigurationId.
	// +kubebuilder:validation:Optional
