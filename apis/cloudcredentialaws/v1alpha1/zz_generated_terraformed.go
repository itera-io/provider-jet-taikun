...
func (tr *CredentialAws) GetObservation() (map[string]any, error) {
...
func (tr *CredentialAws) SetObservation(obs map[string]any) error {
...
func (tr *CredentialAws) GetParameters() (map[string]any, error) {
...
func (tr *CredentialAws) SetParameters(params map[string]any) error {
