...
type CredentialObservation struct {
	...
	// The creator of the backup credential.
	CreatedBy *string `json:"createdBy,omitempty" tf:"created_by,omitempty"`

	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// Indicates whether the backup credential is the organization's default.
	IsDefault *bool `json:"isDefault,omitempty" tf:"is_default,omitempty"`

	// Time and date of last modification.
	LastModified *string `json:"lastModified,omitempty" tf:"last_modified,omitempty"`

	// The last user to have modified the backup credential.
	LastModifiedBy *string `json:"lastModifiedBy,omitempty" tf:"last_modified_by,omitempty"`

	// The name of the organization which owns the backup credential.
