...
type ProfileObservation struct {
	...
	// Container Network Interface (CNI) of the Kubernetes profile.
	Cni *string `json:"cni,omitempty" tf:"cni,omitempty"`

	// The creator of the Kubernetes profile.
	...
	// The last user to have modified the Kubernetes profile.
	LastModifiedBy *string `json:"lastModifiedBy,omitempty" tf:"last_modified_by,omitempty"`

	// The name of the organization which owns the Kubernetes profile.
