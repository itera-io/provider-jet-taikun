...
type BillingRuleAttachmentParameters struct {
	...
	// Reference to a Rule in billingrule to populate billingRuleId.
	// +kubebuilder:validation:Optional
	BillingRuleIDRef *v1.Reference `json:"billingRuleIdRef,omitempty" tf:"-"`

	// Selector for a Rule in billingrule to populate billingRuleId.
	// +kubebuilder:validation:Optional
...
// BillingRuleAttachment is the Schema for the BillingRuleAttachments API. <no value>
