...
func (tr *CredentialAzure) GetObservation() (map[string]any, error) {
...
func (tr *CredentialAzure) SetObservation(obs map[string]any) error {
...
func (tr *CredentialAzure) GetParameters() (map[string]any, error) {
...
func (tr *CredentialAzure) SetParameters(params map[string]any) error {
