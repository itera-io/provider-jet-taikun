...
type CredentialObservation struct {
	...
	// The creator of the showback credential.
	...
	// The last user who modified the showback credential.
	LastModifiedBy *string `json:"lastModifiedBy,omitempty" tf:"last_modified_by,omitempty"`

	// The name of the organization which owns the showback credential.
